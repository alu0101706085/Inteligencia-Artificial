...
class Estado {
 public:
  // Constructores
  Estado() = default;
  Estado(int fila, int columna, int coste, int coste_g, int coste_h) : 
        fila_(fila), columna_(columna), coste_(coste), coste_g_(coste_g), coste_h_(coste_h), coste_f_(coste_g + coste_h) {}
  Estado(int fila, int columna, int coste, int coste_g, int coste_h, Estado estado) : 
        fila_(fila), columna_(columna), coste_(coste), coste_g_(coste_g), coste_h_(coste_h), coste_f_(coste_g + coste_h), estado_anterior_(std::make_unique<Estado>(estado)) {}
  // Getters
  ...
  void SetCosteG(int coste) { coste_ = coste; }
